...
class Type {
    ...
    private $columns = array("type_id", "type_name", "type_created_at");
    private $column_create = array("type_name", "type_created_at");
    
    public $identifierColumn, $identifierValue, $columnName, $columnValue, $tableName, $sql, $status, $result, $total, $countResult, $id, $name, $createdAt;
    
    private $col_id                 = "type_id";
    private $col_name               = "type_name";
    private $col_datetime_created   = "type_created_at";
    ...
    public function create(){
        ...
        if(isset($this->name)) {
            ...
            $sql = "INSERT INTO ".$this->table." (".$imploded.") VALUES('".$name."', '".$dateTimeToday."') ";
            ...
            if($result) {
                ...
                if($result->num_rows > 0) {
                    ...
                    if($row = $result->fetch_object()){
                        ...
                        $this->createdAt    = $row->type_created_at;
