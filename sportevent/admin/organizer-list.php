            ...
            <div class="container-custom">
                ...
                <div class="content-box">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <a class="btn btn-red btn-block search-event" href="organizer-add.php">ADD ORGANIZER</a>
                        </div>
                        <div class="col-md">
                    	...
                    	<table class="table table-striped">
                          <thead>
                            <tr>
                              ...
                              <th scope="col-md">Event Amount</th>
                              <th scope="col-md">Review</th>
                          ...
                          <tbody>
                            <tr>
                              <th scope="row">1</th>
                              <td class=""><p>Kampar Cycling Community</p></td>
                              <td><p>abcdefg@gmail</p></td>
                              <td><p>012345789</p></td>
                              <td><p>100</p></td>
                              <td><p>5.0</p></td>
                              <td><button type="button" class="bg-trans border-0 text-danger font-weight-bold" data-toggle="dropdown">...</button>
                                <div class="dropdown-menu dropdown-menu-right">
                                  <a class="dropdown-item" href="organizer-detail.php">View Detail</a>
