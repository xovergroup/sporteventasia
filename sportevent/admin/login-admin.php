...
<div id="login-page" style="background:whitesmoke;">
	<div class="org-login-logo">
    	<a href="../index.php"><img src="../organizer/img/logo-orange.png" class=""></a>
    </div>
    <div id="org-login-form">
        <form id="loginform" method="post" action="submit-loginadmin.php">
            <h2>For Admin Login</h2>
            <label>E-mail Address</label>
            <input type="email" placeholder="Enter E-mail Address" name="admin_email">
...
<script type="text/javascript">
	document.write('<link href="../organizer/css/style.css?v='+ Math.floor(Math.random()*100) +'" rel="stylesheet" type="text/css" />');
